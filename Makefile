# This Makefile is for the Encode::DoubleEncodedUTF8 extension to perl.
#
...
#     ABSTRACT => q[Fix double encoded UTF-8 bytes to the correct one]
#     AUTHOR => q[Tatsuhiko Miyagawa <miyagawa@bulknews.net>]
#     DIR => []
#     DISTNAME => q[Encode-DoubleEncodedUTF8]
#     NAME => q[Encode::DoubleEncodedUTF8]
#     NO_META => q[1]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], Encode=>q[0.12] }
#     VERSION => q[0.01]
...
NAME_SYM = Encode_DoubleEncodedUTF8
VERSION = 0.01
...
FULLEXT = Encode/DoubleEncodedUTF8
BASEEXT = DoubleEncodedUTF8
PARENT_NAME = Encode
DLBASE = $(BASEEXT)
VERSION_FROM = 
OBJECT = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Encode/DoubleEncodedUTF8.pm
...
TO_INST_PM = lib/Encode/DoubleEncodedUTF8.pm

PM_TO_BLIB = lib/Encode/DoubleEncodedUTF8.pm \
...
DISTNAME = Encode-DoubleEncodedUTF8
DISTVNAME = Encode-DoubleEncodedUTF8-0.01
...
manifypods : pure_all  \
	lib/Encode/DoubleEncodedUTF8.pm \
	lib/Encode/DoubleEncodedUTF8.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Encode/DoubleEncodedUTF8.pm $(INST_MAN3DIR)/Encode::DoubleEncodedUTF8.$(MAN3EXT) 
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Fix double encoded UTF-8 bytes to the correct one</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Tatsuhiko Miyagawa &lt;miyagawa@bulknews.net&gt;</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Encode" VERSION="0,12,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' \
	  lib/Encode/DoubleEncodedUTF8.pm blib/lib/Encode/DoubleEncodedUTF8.pm 
